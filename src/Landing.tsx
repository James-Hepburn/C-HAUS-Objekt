...
export default function Landing() {
    ...
    useEffect(() => {
        ...
        .then(() => {
            // Create confetti burst right before lid lifts off
        ...
        // 6. Fade OUT name and motto after background is visible
        setTimeout(() => {
        name.start({
            opacity: 0,
            y: -150,
        ...
        // 7. Navigate to /home after full sequence
  ...
  return (
    ...
    >
      ...
      <div className="gift">
        ...
        <motion.div className="gift-lid" animate={lid}>
          <div className="bow">
        ...
        <motion.div className="gift-base" animate={base}>
          <motion.div className="motto" initial={{ opacity: 0 }} animate={motto}>
